...
Retorne exatamente:
{
  ...
  "taxaJurosMora": <valor numérico da mora exatamente como consta no contrato, sem converter>,
  "taxaJurosMoraUnidade": <"am" se o contrato expressa mora em % ao mês, "aa" se em % ao ano — analise a redação do contrato com atenção>,
  "taxaMulta": <% de multa por inadimplência ou null>,
  "iof": <valor em reais do IOF cobrado ou null>,
  "tac": <valor em reais da TAC cobrada ou null>,
  "tec": <valor em reais da TEC cobrada ou null>,
  "numeroParcelas": <número total de parcelas ou null>,
            ...
            json_schema: {
              ...
              schema: {
                ...
                properties: {
                  ...
                  taxaJurosMora: { type: ["number", "null"] },
                  taxaJurosMoraUnidade: { type: ["string", "null"] },
                  taxaMulta: { type: ["number", "null"] },
                  iof: { type: ["number", "null"] },
                  tac: { type: ["number", "null"] },
                  tec: { type: ["number", "null"] },
                  numeroParcelas: { type: ["integer", "null"] },
                  nomeBanco: { type: ["string", "null"] },
                ...
                required: [
                  ...
                  "taxaJurosMora", "taxaJurosMoraUnidade", "taxaMulta",
                  "iof", "tac", "tec", "numeroParcelas", "nomeBanco",
